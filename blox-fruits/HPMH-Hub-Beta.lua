    ...
    --    local ToggleV4 = Tabs.Setting:AddToggle("ToggleV4", {Title = "Auto Turn On V4", Default = false })
    --    ToggleV4:OnChanged(function(v4)
    --        ff = v4
    --    end)
    --    if ff then
    ...
    _G.FastAttackDelay = 0.13 -- Test 0.1 Attack Speed if kick or not
